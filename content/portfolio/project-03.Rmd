...
project_images:
title: GAPMINDER ANALYSIS - FERTILITY VS. EDUCATION and much more
type: portfolio
---
...
geom_smooth(colour="blue") +
 theme_bw() +
  labs (
    title = "Over time the relationship between HIV prevalance and life expectancy is getting stronger - \nthe less HIV prevalence, the higher the life expectancy", 
 ...
 theme_bw() + 
  labs(title = "Sub-saharan Africa has the lowest quality of the HIV data", 
    ...
    theme(panel.grid.major.y = element_line(color = "gray60", size = 0.1),
        ...
        axis.ticks = element_line(size = 3,colour = "grey80"),
        axis.ticks.length = unit(.20, "cm"),
        plot.title = element_text(color = "black",size=20,face="bold", family= "Montserrat"),
        plot.subtitle = element_text(color = "black",size=15,face="plain", family= "Montserrat"),
        axis.title.y = element_text(size = 12, angle = 90, family="Montserrat", face = "plain"),
        ...
        legend.title=element_text(family="Montserrat", size=12, face="bold"))
